---
name: video-summary
description: Summarize interview-style videos using summary_guidelines.md (evidence-first protocol).
---
...
- Follow `summary_guidelines.md` in this skill directory exactly.
...
2) Build the summary strictly per `summary_guidelines.md`:
  - **DETERMINE MODE**: Use **Mode 2 (V4 Dynamic Scale-to-Length Deep-Dive)** for all summaries.
...
- 2026-03-24: Removed Mode 1 (Short/Thesis-Driven), Mode 2 is now the only mode for all summaries
